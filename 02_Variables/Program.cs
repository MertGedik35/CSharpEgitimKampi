...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Yolcu T.C. Kimlik No: " + passengerIdentityNumber + " - Yolcu Ad Soyad: " + 
            //    passengerName + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity);
            ...
            //Console.Write("Lütfen TV Adetini Giriniz: ");
